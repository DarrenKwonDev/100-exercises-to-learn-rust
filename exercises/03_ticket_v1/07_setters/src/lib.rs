...
impl Ticket {
    ...
    fn title_validation(title: &String) {
        if title.is_empty() {
    ...
    fn description_validation(description: &String) {
    ...
    fn status_validation(status: &String) {
    ...
    pub fn new(title: String, description: String, status: String) -> Ticket {
        ...
        Self::title_validation(&title);
        Self::description_validation(&description);
    ...
    pub fn set_title(&mut self, new_title: String) {
        Self::title_validation(&new_title);
        self.title = new_title
    }
    pub fn set_description(&mut self, new_description: String) {
        Self::description_validation(&new_description);
        self.description = new_description
    }
    pub fn set_status(&mut self, new_status: String) {
        Self::status_validation(&new_status);
